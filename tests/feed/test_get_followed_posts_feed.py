"""Tests for 'get_followed_posts_feed' endpoint."""
...
def test_get_followed_posts_feed_returns_200_with_correct_response(
    ...
    response = client.get("/feed/accounts/3/posts/followed?limit=5&offset=1", headers=headers)
